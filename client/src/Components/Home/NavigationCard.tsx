    ...
    return (
        <Card>
            <div className="px-4 py-2">
                ...
                <Link to="/Login" className={`flex gap-3 py-3 hover:bg-indigo-300 hover:shadow-md hover:shadow-gray-700 -mx-10 px-10 rounded-xl transition-all hover:scale-105 ${!isHomePage && !isDashboard ? 'hover:shadow-md' : ''}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
